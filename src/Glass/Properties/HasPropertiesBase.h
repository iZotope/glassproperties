...
namespace Glass {
	...
	public:
		...
		void SetStyleSheetBase(shared_ptr<Util::StyleSheet> styleSheet);
		void AddClassNameBase(const std::string& className);
		void SetClassNamesBase(const vector<std::string>& classNames);
